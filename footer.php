    ...
    <nav id="share-menu" class="close">
        <ul>
            ...
            <li class="evernote"><a href="#" onclick="Evernote.doClip({url:'<?php meta_url();?>',providerName:'<?php bloginfo('name');?>',title:'<?php the_title();?>',contentId:'site-main',}); return false;"><i class="fa fa-sticky-note-o fa-5x" aria-hidden="true"></i></a></li>
