    ...
    <script>
        (function(){var h='<style>.singular{padding-top:' + document.getElementsByClassName('article-img').offsetHeight + ';}</style>';document.open();document.writeln(h);document.close();});
