    ...
    <div id="menu-wrap" class="close">
        <nav class="menu-tab">
            <a href="javascript:void(0)" id="main-menu-toggle" class="close" tabindex="0" role="button" title="メニューへのリンク" onclick="document.getElementById('main-menu').classList.toggle('none');document.getElementById('main-menu').classList.toggle('block');"><i class="fa fa-bars fa-5x"></i></a>
        ...
        <div id="main-menu" class="block">
            ...
            <?php if(has_nav_menu('main')):?>
                <nav class="main-nav">
                    <?php wp_nav_menu(array('theme_location'=>'main','container'=>false,'items_wrap'=>'<ul id="%1$s" class="%2$s" itemscope itemtype="http://schema.org/SiteNavigationElement">%3$s</ul>','walker'=>new add_meta_Social_Menu));?>
                </nav>
            <?php endif;?>
