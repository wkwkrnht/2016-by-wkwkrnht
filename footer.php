    ...
    <footer>
        ...
        <a href="javascript:void(0)" id="button-toggle" title="メニューボタン" onclick="document.getElementByClass('fa-th-large').classList.toggle('close');document.getElementByClass('fa-th-large').classList.toggle('open');document.getElementByClass('fa-times').classList.toggle('close');document.getElementByClass('fa-times').classList.toggle('open');document.getElementById('home-button').classList.toggle('close');document.getElementById('home-button').classList.toggle('open');document.getElementById('menu-toggle').classList.toggle('close');document.getElementById('menu-toggle').classList.toggle('open');document.getElementById('share-menu-toggle').classList.toggle('close');document.getElementById('share-menu-toggle').classList.toggle('open');"><i class="fa fa-th-large fa-5x open" aria-hidden="true"></i><i class="fa fa-times fa-5x close" aria-hidden="true"></i></a>
