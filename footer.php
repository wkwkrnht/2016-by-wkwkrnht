    ...
    <footer>
        <a href="javascript:void(0)" id="menu-toggle" class="close" title="<?php _e('menu-link','2016-by-wkwkrnht');?>" onclick="document.getElementById('main-menu').classList.toggle('close');document.getElementById('main-menu').classList.toggle('open');"><i class="fa fa-bars fa-5x"></i></a>
        <?php $script='';if(is_home()===false){echo'<a href="' . esc_url(home_url()) . '" title="' . __('home-button','2016-by-wkwkrnht') , '" id="home-button" class="close"><i class="fa fa-home fa-5x" aria-hidden="true"></i></a>';$script="document.getElementById('home-button').classList.toggle('close');document.getElementById('home-button').classList.toggle('open');";}?>
        <a href="javascript:void(0)" id="button-toggle" title="<?php _e('menu-button','2016-by-wkwkrnht');?>" onclick="document.getElementById('toggle-ok').classList.toggle('none');document.getElementById('toggle-ok').classList.toggle('inline-block');document.getElementById('toggle-no').classList.toggle('none');document.getElementById('toggle-no').classList.toggle('inline-block');<?php echo $script;?>document.getElementById('menu-toggle').classList.toggle('close');document.getElementById('menu-toggle').classList.toggle('open');document.getElementById('share-menu-toggle').classList.toggle('close');document.getElementById('share-menu-toggle').classList.toggle('open');"><i id="toggle-ok" class="fa fa-th-large fa-5x open" aria-hidden="true"></i><i id="toggle-no" class="fa fa-times fa-5x close" aria-hidden="true"></i></a>
        <a href="javascript:void(0)" id="share-menu-toggle" class="close" title="<?php _e('share-link','2016-by-wkwkrnht');?>" onclick="document.getElementById('share-menu').classList.toggle('close');document.getElementById('share-menu').classList.toggle('open');"><i class="fa fa-share-alt fa-5x"></i></a>
    </footer>
