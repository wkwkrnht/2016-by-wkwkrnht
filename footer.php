    ...
    <footer>
        ...
        <a href="javascript:void(0)" id="button-toggle" title="メニューボタン" onclick="document.getElementById('toggle-ok').classList.toggle('close');document.getElementById('toggle-ok').classList.toggle('open');document.getElementById('toggle-no').classList.toggle('close');document.getElementById('toggle-no').classList.toggle('open');document.getElementById('home-button').classList.toggle('close');document.getElementById('home-button').classList.toggle('open');document.getElementById('menu-toggle').classList.toggle('close');document.getElementById('menu-toggle').classList.toggle('open');document.getElementById('share-menu-toggle').classList.toggle('close');document.getElementById('share-menu-toggle').classList.toggle('open');"><i id="toggle-ok" class="fa fa-th-large fa-5x open" aria-hidden="true"></i><i id="toggle-no" class="fa fa-times fa-5x close" aria-hidden="true"></i></a>
