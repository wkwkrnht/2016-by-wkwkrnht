	...
	*/
	...
	<?php if(is_singular()===true):?>
		...
		*/
		...
		.article-main .wrap{height:0;padding-bottom:56.25%;width:100%;max-width:80vw;margin:3vh auto;position:relative;overflow:hidden;}
		.article-main .wrap > iframe{width:100%;height:100%;position:absolute;top:0;left:0;}
