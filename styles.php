<style>
	...
	*/
	...
	#share-menu .buffer{background-color:#333;font-size:4rem;font-weight:900;top:25%;}
	...
	#share-menu .hatebu{background-color:#00a5de;font-size:5rem;font-weight:900;top:25%;}
