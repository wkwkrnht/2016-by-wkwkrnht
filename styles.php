<style>
	...
	body{width:100%;padding-bottom:20vh;margin:0;overflow-y:scroll;}
	...
	*/
	...
	#menu-toggle{bottom:10vh;left:calc(50% - 25vh);}
	#home-button{bottom:22vh;left:calc(50% - 7.5vh);}
	#button-toggle{bottom:3vh;left:calc(50% - 7.5vh);}
	#share-menu-toggle{bottom:10vh;left:calc(50% + 10vh);}
	...
	#share-menu .buffer{background-color:#333;font-size:4rem;font-weight:900;vertical-align:middle;}
	...
	#share-menu .hatebu{background-color:#00a5de;font-size:5rem;font-weight:900;vertical-align:middle;}
	#share-menu li.instapaper{background-color:#fff;}
	#share-menu li.instapaper > a{color:#333;font:900 5rem/1.9 serif;vertical-align:middle;}
