<style>
	...
	*/
	...
	.toc{width:90vw;padding-bottom:4vh;margin:4vh auto;box-shadow:0 0 3vmin rgba(0,0,0,.2);}
	...
	.ogp-blogcard-share{height:calc(37vh + 2vmin * 2);width:calc(80vw + 5vmin * 2);border-radius:3vmin;position:absolute;top:2vmin;left:5vmin;z-index:2;background-color:rgba(0,0,0,.3);}
	...
	.ogp-blogcard-share-toggle{display:block;height:5em;width:5em;border-radius:50%;position:absolute;top:0;left:0;color:#fff;background-color:#03a9f4;text-align:center;line-height:5em;}
	...
	<?php if(is_singular()===true):?>
		...
		*/
		...
		.article-main .ogp-blogcard-main{border:0;}
