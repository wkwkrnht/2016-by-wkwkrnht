<style>
	...
	*/
	...
	body{width:100%;padding-bottom:18vh;margin:0;}
	...
	.fa{display:inline-block;font:normal normal normal 62.5%/1 "FontAwesome";text-rendering:auto;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale}
	...
	*/
	...
	.widget-title{min-height:5vh;max-width:94%;margin:2vh auto;line-height:5vh;text-align:center;color:<?php echo get_option('widget_title_color','#fff');?>;background-color:<?php echo get_option('widget_title_background','#03a9f4');?>;}
	...
	*/
	...
	.widget_tag_cloud a{display:inline-block;max-width:100px;height:28px;padding:0 1em;margin:0 .3em .3em 0;background-color:#fff;border:1px solid <?php echo get_option('tag_cloud_border','#03a9f4');?>;border-radius:3vmin;color:<?php echo get_option('tag_cloud_color','#333');?>;font-size:1.6rem;text-decoration:none;white-space:nowrap;text-overflow:ellipsis;overflow:hidden;}
