<style>
	...
	*/
	...
	.site-header{height:18%;width:100%;padding:5vh 10%;margin:0 0 5vh 0;<?php if(get_header_image()){echo'background-image:url(' . get_header_image() . ');';}else{echo'background-color:' . get_option('site_header_background','#fff') . ';';}?>}
	.site-header,.site-header a{color:<?php echo get_option('site_header_color','#333');?>;}
