<style>
	...
	*/
	...
	.hide-nav-prev a,.hide-nav-next a{display:table-cell;height:100vh;width:10vw;font-size:4rem;text-align:center;vertical-align:middle;color:<?php echo get_option('nav_a_color','#fff');?>;background-color:<?php echo get_option('nav_a_background','#03a9f4');?>;transition:transform 0.2s linear;}
