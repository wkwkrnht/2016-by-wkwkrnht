<style>
	...
	*/
	...
	.open#menu-wrap ~ #button-toggle{transform:rotate(45deg);}
	#menu-toggle,.menu-tab{background-color:<?php echo get_option('footer_background','#03a9f4');?>;color:<?php echo get_option('footer_color','#fff');?>;}
	#menu-toggle:visited,.menu-tab a,.menu-tab a:visited{color:<?php echo get_option('footer_color','#fff');?>;}
	.menu-tab{height:8vh;width:86vw;}
	.menu-tab a{display:inline-block;height:8vh;box-sizing:border-box;padding:1vh 0;margin:0;text-align:center;}
