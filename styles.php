<style>
	...
	*/
	...
	#share-menu .buffer{background-color:#333;font-size:4rem;font-weight:900;top:30%;}
	...
	#share-menu .hatebu{background-color:#00a5de;font-size:5rem;font-weight:900;top:30%;}
	#share-menu li.instapaper{background-color:#fff;}
	#share-menu li.instapaper > a{color:#333;font:900 5rem/1.9 serif;top:30%;}
