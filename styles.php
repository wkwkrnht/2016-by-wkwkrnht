<style>
	...
	:root{font:400 62.5%/1.9 -apple-system,"Lucida Grande","Helvetica Neue","Hiragino Kaku Gothic ProN","游ゴシック","メイリオ",meiryo,sans-serif;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;color:<?php echo get_option('root_color','#333');?>;}
	...
	*/
	...
	.widget-title{min-height:5vh;max-width:94%;margin:2vh auto;line-height:5vh;text-align:center;color:<?php echo get_option('widget_title_color','#fff');?>;background-color:<?php echo get_option('widget_title_color','#03a9f4');?>;}
