<style>
	...
	*/
	...
	6.move to search
	*/
	.card{height:45vmin;width:80vmin;margin:4vmin 5vmin;padding:2vmin 3.5vmin;border-radius:3vmin;font-size:1.8rem;text-align:center;overflow-y:auto;background-color:#fff;box-shadow:0 0 3vmin rgba(0,0,0,.2);}
