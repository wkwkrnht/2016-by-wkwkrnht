<style>
	...
	:root{font:400 62.5%/1.9 -apple-system,"Lucida Grande","Helvetica Neue","Hiragino Kaku Gothic ProN","游ゴシック","メイリオ",meiryo,sans-serif;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;color:#333;}
	a,a:visited{color:<?php echo get_option('a_color','#03a9f4');?>;text-decoration:none;}
	#site-main{width:100%;padding-bottom:16vh;}
	...
	*/
	...
	.widget_tag_cloud a{display:inline-block;max-width:100px;height:28px;padding:0 1em;margin:0 .3em .3em 0;background-color:#fff;border:1px solid #aaa;border-radius:5px;white-space:nowrap;text-overflow:ellipsis;overflow:hidden;color:#333;font-size:1.6rem;text-decoration:none;}
	...
	5.move to search
	*/
	.card{height:45vmin;width:80vmin;margin:3vmin 10vmin;padding:4vmin 3vmin;border-radius:3vmin;font-size:1.8rem;text-align:center;overflow-y:auto;background-color:#fff;box-shadow:0 0 3vmin rgba(0,0,0,.3);}
	...
	.toc{width:90vw;padding-bottom:3vh;margin:3vh auto;box-shadow:0 0 5vmin rgba(0,0,0,.3);}
	...
	.ogp-blogcard-share > ul > li{display:inline-block;padding:1em;margin:5vmin;border:1px solid #fff;font-size:2.2rem;}
	...
	*/
	...
	.article-tag a{display:inline-block;width:5em;height:2.5em;padding:0 1em;margin:0 .3em .3em 0;border-radius:5px;border:1px solid #aaa;background-color:#fff;color:#333;font-size:1.6rem;text-decoration:none;white-space:nowrap;text-overflow:ellipsis;overflow:hidden;}
	...
	.article-main h1{padding:.75em;background-color:<?php echo get_option('article_main_h1_background','#f4f4f4');?>;border-top:1px dashed <?php echo get_option('article_main_h_border','#ccc');?>;border-bottom:1px dashed <?php echo get_option('article_main_h_border','#ccc');?>;box-shadow:0 7px 10px -5px rgba(0,0,0,.1) inset;counter-increment:counter-h1;counter-reset:counter-h2;}
	.article-main h2{color:<?php echo get_option('article_main_h2_color','#fff');?>;background-color:<?php echo get_option('article_main_h2_background','#03a9f4');?>;box-shadow:0 0 3vmin rgba(0,0,0,.1);counter-increment:counter-h2;counter-reset:counter-h3;}
	.article-main h3{border:1vmin solid <?php echo get_option('article_main_h3_border','#03a9f4');?>;color:<?php echo get_option('article_main_h3_color','#03a9f4');?>;box-shadow:0 3px 6px rgba(0,0,0,.1);counter-increment:counter-h3;counter-reset:counter-h4;}
	...
	.article-main .wrap{max-width:80vw;margin:2vh auto;}
	...
	.article-main ul li::after,.article-main ol li::after{content:'';display:block;height:0;width:100%;position:relative;top:0;left:0;border-bottom:1px dashed <?php echo get_option('article_main_li_border','#aaa');?>;}
	...
	.article-main .toc-title{max-width:90vw;}
	...
	.article-main .ogp-blogcard-title:visited,.article-main .ogp-blogcard-description:visited,.article-main .ogp-blogcard-site-name:visited{color:#333;}
	.article-main .ogp-blogcard-title{border:none;}
	...
	*/
	@media all and (orientation: landscape){
	    ...
	    @media screen and (max-height:720px){
	    	...
	    	.card{font-size:1.2rem;margin:2.5vmin auto;box-shadow:0 0 3vmin rgba(0,0,0,0);}
	...
	@media all and (orientation: portrait){
	    ...
	    @media screen and (max-width:450px){
	        ...
	        .search-form .sbtn::after{font-size:2rem;margin-left:-10px;}
	    }
	}
	@media print{
	    :root{font-size:10pt;}
	    .toggle-zone,#main-menu,#share-menu{display:none;}
	}
