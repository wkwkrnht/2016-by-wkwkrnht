<style>
	...
	*/
	...
	<?php if(is_singular()===true):?>
		...
		11.codex
		*/
		.article-header{height:0;width:100%;padding-top:56.25%;position:relative;margin-bottom:4vh;text-align:center;vertical-align:middle;}
		.article-eyecatch{max-width:100%;position:absolute;bottom:0;}
		.article-meta{width:100%;position:absolute;bottom:0;font-size:2rem;background-image:linear-gradient(to top,<?php $color = color_to_rgb($colorcode = get_option('article_meta_background','#f1f1f1'));echo'rgba(' . $color["red"] . ',' . $color["green"] . ',' . $color["blue"] . ',.8)';?>,rgba(0,0,0,0));}
