...
function theme_customize($wp_customize){
    ...
    $wp_customize->add_section('sns_section',array('title'=>'2016-by-wkwkrnht','description'=>'このテーマの独自設定',));
...
add_action('wp_head',function(){include_once(get_template_directory() . '/styles.php');});
