<style>
	...
	$eot   = 'url("' . $url . '/inc/font-awesome/fontawesome-webfont.eot")';
	$IE    = 'url("' . $url . '/inc/font-awesome/fontawesome-webfont.eot?#iefix")';
	$woff2 = 'uri("' . $url . '/inc/font-awesome/fontawesome-webfont.woff2")';
	$woff  = 'url("' . $url . '/inc/font-awesome/fontawesome-webfont.woff")';
	$ttf   = 'url("' . $url . '/inc/font-awesome/fontawesome-webfont.ttf")';
	$svg   = 'url("' . $url . '/inc/font-awesome/fontawesome-webfont.svg#fontawesomeregular")';
	?>
	...
	6.ウィジェットエリア
	*/
	.toggle-zone{height:20vh;width:100%;position:fixed;bottom:0;left:0;z-index:100;background-color:#03a9f4;font-family:"FontAwesome";font-size:200%;line-height:20vh;text-align:center;vertical-align:middle;opacity:.7;box-shadow:0 0 15px rgba(0,0,0,.3);}
	#share-toggle,#share-menu-toggle,#menu-toggle{display:inline-block;height:inherit;width:33%;color:#fff;}
	#share-toggle:visited,#share-menu-toggle:visited,#menu-toggle:visited{color:#fff;}
	...
	#share-menu .close-button,#main-menu .close-button{display:block;height:73vh;width:6vw;padding:0;margin:0;position:fixed;right:7vw;z-index:111;font-size:3vw;color:red;text-decoration:none;text-align:center;}
	...
	.tweet{background-color:#55acee;}
	.fb-like{background-color:#3b5998;}
	.line{background-color:#6cc655;}
	.reddit{background-color:#ff5700;}
	.g-plus{background-color:#dc4e41;}
	.linkedin{background-color:#36465d;}
	.pinterest{background-color:#bd081c;}
	.hatebu{background-color:#00a5de;font-size:3rem;font-weight:900;}
	.pocket{background-color:#ef3f56;}
	.tumblr{background-color:#36465d;}

	#main-menu{padding-top:2vh;background-color:#fff;}
	...
	.social-nav a::before{content:'\f07b';display:inline-block;font:400 28px/1.8 "FontAwesome";font-style:normal;font-variant:normal;speak:none;text-align:center;text-decoration:none;text-transform:none;position:absolute;top:0;left:0;}
	.social-nav a[href*="amazon.co.jp"]::before{content:'\f270';}
	...
	.social-nav a[href*="goo.gl/forms/"]::before{content:'\f128';}
	...
	.social-nav a[href*="nicovideo.jp"]::before{content:'\f26c';}
	...
	.social-nav a[href*="twilog.org"]::after{content:"\f022";font-family:"FontAwesome";font-size:16px;position:relative;right:1em;bottom:0;}
	.social-nav a[href*="twipf.jp"]::before{content:"\f099";color:#00b8ff;}
	.social-nav a[href*="twipf.jp"]::after{content:"\f007";font-family:"FontAwesome";font-size:16px;position:relative;right:0;bottom:0;}
	...
	*/
	...
	.widget_tag_cloud a{display:inline-block;max-width:100px;height:28px;padding:0 1em;margin:0 .3em .3em 0;background-color:#fff;border:1px solid #aaa;border-radius:5px;white-space:nowrap;text-overflow:ellipsis;overflow:hidden;color:#333;font-size:1.6rem;text-decoration:none;-webkit-transition:.2s;transition:.2s;}

	.widget_recent_entries ul{list-style-type:none;}
	.widget_recent_entries ul li{border-bottom:1px dashed #aaa;}
	.widget_recent_entries ul li a{text-decoration:none;color:#333;font-size:1.6rem;}
	...
	*/
	...
	.ogp-blogcard-img{display:inline-block;max-height:40%;max-width:40%;}
	.ogp-blogcard-info{display:inline-block;max-height:40%;max-width:60%;text-align:center;}
	...
	2.ページネーション
	*/
	.card{height:45vmin;width:80vmin;margin:3vmin 10vmin;padding:4vmin 3vmin;border-radius:5px;font-size:1.8rem;text-align:center;background-color:#fff;box-shadow:0 0 15px rgba(0,0,0,.3);}
	.card img{display:block;float:left;max-height:39vmin;max-width:calc(80vmin / 2 - 1vmin);vertical-align:middle;}
	...
	.page-nation{list-style:none;height:10vw;width:80vw;margin:5vmin auto;background-color:#fff;box-shadow:0 0 15px rgba(0,0,0,.3);display:flex;flex-wrap:wrap;justify-content:center;align-items:center;}
	.page-nation a,.page-nation .current,.page-nation li .dots{padding:2vmin;margin:0 .5vmin;border:solid .5vmin #00a5de;font-weight:bold;}
	.page-nation a,.page-nation li .dots{background-color:#fff;font-size:1.3rem;text-decoration:none;}
	/*
    	記事ページ
	1.ヘッダー
	2.メイン
	...
	*/
	...
	.article-meta{min-height:23vh;width:92vw;background-color:#f1f1f1;font-size:1.6rem;text-align:center;vertical-align:middle;}
	.article-date{display:block;height:inherit;width:30%;float:left;background-color:#03a9f4;color:#fff;font-size:2.3rem;line-height:23vh;}
	.article-title{font-size:2rem;}
	.bread-sp{margin:0 .5em;}
	.article-tag{padding:0;margin:3vmin;}
	.article-tag a{display:inline-block;width:5em;height:2.5em;padding:0 1em;margin:0 .3em .3em 0;border-radius:5px;border:1px solid #aaa;background-color:#fff;color:#333;font-size:1.6rem;text-decoration:none;white-space:nowrap;text-overflow:ellipsis;overflow:hidden;-webkit-transition:.2s;transition:.2s;}
	...
	.article-main blockquote,.article-main q,.article-main pre,.article-main address{padding:1em 2em;border:1px solid #bbb;border-radius:5px;}
	...
	.article-main blockquote,.article-main q{quotes:none;}
	.article-main blockquote::after{content:attr(title)'\a'attr(cite);display:block;padding-top:1em;border-top:1px solid #bbb;text-align:right;white-space:-moz-pre-wrap;white-space:pre-wrap;word-wrap:break-word;}
	.article-main .wrap{max-width:960px;margin:2vh auto;}
	.article-main .wrap > div{padding-bottom:56.25%;height:0;width:100%;position:relative;overflow:hidden;}
	.article-main .wrap > div > iframe{width:100%;height:100%;position:absolute;top:0;left:0;}
	...
	.article-main table tr th{color:#fff;background-color:#03a9f4;}
	...
	.article-main .ogp-blogcard-title{background-color:transparent;box-shadow:none;}
	...
	.wp-caption.alignnone{margin:2vh 3vw 5vh 0;}
	.wp-caption.alignleft{margin:2vh 3vw 5vh 0;}
	.wp-caption.alignright{margin:2vh 0 5vh 3vw;}
	.wp-caption img{height:auto;width:auto;max-width:98.5%;border:none;margin:0;padding:0;}
	...
	*/
	@media all and (orientation: landscape){
    	...
    	@media screen and (max-height:720px){
    		...
    		.card{font-size:1.2rem;margin:2.5vmin auto;box-shadow:0 0 15px rgba(0,0,0,0);}
	...
	@media all and (orientation: portrait){
    	...
    	@media screen and (max-width:450px){
        	...
        	.search-form .sbtn::after{font-size:20px;margin-left:-10px;}
    	}
	}
	@media print {
