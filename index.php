    	...
    	<?php if(have_posts()):while(have_posts()):the_post();?>
			...
			<section class="card article-card">
		        ...
		        <div class="card-info">
		            ...
		            <span class="card-meta">公開日：<time class="entry-date updated" datetime="<?php echo get_mtime('Y/m/d');?>"><?php the_time('Y/n/j');?></time><br><?php echo'著者：<a href="' . site_url() . '?author=' . get_the_author_meta('ID') . '"><span class="vcard author"><span class="fn">';the_author();echo'</span></span></a><br>カテゴリー:';the_category(', ');?></span>
		        </div>
		    </section>
		<?php endwhile;endif;?>
	</div>
