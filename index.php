	...
	<div class="article-list">
    	<?php if(have_posts()):while(have_posts()):the_post();?>
			<section class="card article-card">
		        <a href="<?php the_permalink();?>" title="<?php the_title_attribute();?>" class="article-eye"><img src="<?php $size=array(1200,800);wkwkrnht_eyecatch($size);?>" alt="eyecatch" height="800" width="1280"></a>
		        <div class="card-info">
		            <a href="<?php the_permalink();?>" title="<?php the_title_attribute();?>" class="card-eyecatch"><h2 class="article-name"><?php $title = mb_strimwidth(get_the_title(),0,32,…);echo $title;?></h2></a><br>
