				...
				<section class="card article-card">
		        	...
		        	<div class="card-info">
		            	...
		            	<span class="card-meta">
							<?php _e('date','2016-by-wkwkrnht');?>：<time class="entry-date updated" datetime="<?php the_time('Y-m-d');?>"><?php the_time('Y/n/j');?></time><br>
							<?php _e('author','2016-by-wkwkrnht');?> ：<?php echo'
							...
							. __('category','2016-by-wkwkrnht') . ' : ';the_category(', ');?>
						</span>
		        	</div>
		    	</section>
			<?php endwhile;endif;?>
