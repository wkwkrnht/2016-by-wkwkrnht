    	...
    	<?php if(have_posts()):while(have_posts()):the_post();?>
			<section class="card article-card">
		        ...
		        <div class="card-info">
		            ...
		            <span class="card-meta">公開日：<time class="entry-date" datetime="<?php echo get_mtime('Y/n/j G:i.s');?>"><?php the_time('Y/n/j');?></time><br><?php echo'著者：<a href="' . get_the_author_meta('user_url') . '">';the_author();echo'</a><br>カテゴリー:';the_category(', ');?></span>
		        </div>
		    </section>
		<?php endwhile;endif;?>
	</div>
