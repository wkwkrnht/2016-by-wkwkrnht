	...
	<main id="site-main">
	    ...
	    echo'<header class="site-header" itemscope itemtype="http://schema.org/WPHeader">';
	        if(is_category()===true){
	            ...
	            echo'<a href="' . site_url() . '" tabindex="0" itemprop="url"><h1 class="site-title" itemprop="name headline">' . $blogname . '</h1><p class="site-description" itemprop="about">' . get_bloginfo('description') . '</p></a>';
			}
	        echo'<br>
