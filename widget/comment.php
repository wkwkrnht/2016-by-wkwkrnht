...
<style>
    ...
    .comment-title::after{content:'<?php echo get_comments_number();?>';display:inline-block;height:2rem;width:2rem;border-radius:50%;text-align:center;font-size:2rem;line-height:2rem;color:#fff;background-color:#00bcd4;box-shadow:3px 0 5px rgba(0,0,0,.3);}
