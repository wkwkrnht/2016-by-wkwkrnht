...
<style>
    ...
    .comment-title::after{content:'<?php echo get_comments_number();?>';display:inline-block;height:2em;width:2em;border-radius:50%;text-align:center;vertical-align:middle;font-size:2rem;line-height:2rem;color:#fff;background-color:#00bcd4;box-shadow:3px 0 5px rgba(0,0,0,.3);}
