...
<header class="bio-wrapper card info-card" <?php if(is_author()===true){echo'itemscope itemtype="http://schema.org/WPHeader"';}?>>
    ...
    <ul class="follow-button" itemscope itemtype=”http://schema.org/SiteNavigationElement”>
        <?php $tw = '';$tw = get_the_author_meta('twitter');if($tw!==''){echo'<li><a href="https://twitter.com/' . $tw . '" tabindex="0" itemprop=”url”><i class="fa fa-twitter-square fa-3x" aria-hidden="true"></i></a></li>';}?>
        <?php $fb = '';$fb = get_the_author_meta('facebook');if($fb!==''){echo'<li><a href="https://www.facebook.com/profile.php?id=' . $fb . '" tabindex="0" itemprop=”url”><i class="fa fa-facebook-official fa-3x" aria-hidden="true"></i></a></li>';}?>
        <?php $Instagram = '';$Instagram = get_the_author_meta('Instagram');if($Instagram!==''){echo'<li><a href="https://www.instagram.com/' . $Instagram . '" tabindex="0" itemprop=”url”></a></li>';}?>
        <?php $line = '';$line = get_the_author_meta('LINE');if($line!==''){echo'<li>' . $line . '</li>';}?>
        <?php $gp = '';$gp = get_the_author_meta('Googleplus');if($gp!==''){echo'<li><a href="https://plus.google.com/u/0/' . $gp . '" tabindex="0" itemprop=”url”><i class="fa fa-google-plus-official fa-3x" aria-hidden="true"></i></a></li>';}?>
        <?php $ld = '';$ld = get_the_author_meta('Linkedin');if($ld!==''){echo'<li><a href="https://jp.linkedin.com/in/' . $ld . '" tabindex="0" itemprop=”url”><i class="fa fa-linkedin-square fa-3x" aria-hidden="true"></i></a></li>';}?>
        <?php $vine = '';$vine = get_the_author_meta('vine');if($vine!==''){echo'<li><a href="' . $vine . '" tabindex="0" itemprop=”url”><i class="fa fa-vine" aria-hidden="true"></i></a></li>';}?>
        <?php $vimeo = '';$vimeo = get_the_author_meta('vimeo');if($vimeo!==''){echo'<li><a href="' . $vimeo . '" tabindex="0" itemprop=”url”><i class="fa fa-vimeo-square" aria-hidden="true"></i></a></li>';}?>
        <?php $niconico = '';$niconico = get_the_author_meta('niconico');if($niconico!==''){echo'<li><a href="' . $niconico . '" tabindex="0" itemprop=”url”><i class="fa fa-television" aria-hidden="true"></i></a></li>';}?>
        <?php $YouTube = '';$YouTube = get_the_author_meta('YouTube');if($YouTube!==''){echo'<li><a href="https://youtube.com/channel/' . $YouTube . '" tabindex="0" itemprop=”url”><i class="fa fa-youtube-square" aria-hidden="true"></i></a></li>';}?>
        <?php $Twitch = '';$Twitch = get_the_author_meta('Twitch');if($Twitch!==''){echo'<li><a href="' . $Twitch . '" tabindex="0" itemprop=”url”><i class="fa fa-twitch" aria-hidden="true"></i></a></li>';}?>
        <?php $USTREAM = '';$USTREAM = get_the_author_meta('USTREAM');if($USTREAM!==''){echo'<li><a href="' . $USTREAM . '" tabindex="0" itemprop=”url”></a></li>';}?>
        <?php $fc2 = '';$fc2 = get_the_author_meta('fc2');if($fc2!==''){echo'<li><a href="' . $fc2 . '" tabindex="0" itemprop=”url”></a></li>';}?>
        <?php $livedoor = '';$livedoor = get_the_author_meta('livedoor');if($livedoor!==''){echo'<li><a href="' . $livedoor . '" tabindex="0" itemprop=”url”></a></li>';}?>
        <?php $ameba = '';$ameba = get_the_author_meta('ameba');if($ameba!==''){echo'<li><a href="' . $ameba . '" tabindex="0" itemprop=”url”></a></li>';}?>
        <?php $mixi = '';$mixi = get_the_author_meta('mixi');if($mixi!==''){echo'<li><a href="' . $mixi . '" tabindex="0" itemprop=”url”></a></li>';}?>
        ...
        <?php $xda = '';$xda = get_the_author_meta('xda');if($xda!==''){echo'<li><a href="' . $xda . '" tabindex="0" itemprop=”url”></a></li>';}?>
