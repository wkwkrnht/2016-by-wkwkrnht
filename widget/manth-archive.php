<style>
    ...
    .widget_wkwkrnht_manth_archive .list-year{margin:1em 0;background-color:<?php echo get_option('manth_archive_year_background','#03a9f4');?>;border:1px solid <?php echo get_option('manth_archive_year_border','#03a9f4');?>;}
