<style>
    ...
    .widget_wkwkrnht_manth_archive .article-list{list-style:none;margin:1.5em 0 .5em;background-color:#fff;display:flex;flex-wrap:wrap;justify-content:flex-start;align-items:center;}
