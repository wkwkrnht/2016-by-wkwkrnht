<style>
    ...
    .widget_wkwkrnht_manth_archive .article-list{list-style:none;padding:.75em 0;margin-top:1em;background-color:#fff;display:flex;flex-wrap:wrap;justify-content:flex-start;align-items:center;}
