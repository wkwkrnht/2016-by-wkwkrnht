<style>
    ...
    .widget_wkwkrnht_manth_archive > ul > .list-year > h3{display:inline-block;width:calc(30% - 1vmin);text-align:center;background-color:<?php echo get_option('manth_archive_year_background','#03a9f4');?>;}
    ...
    .widget_wkwkrnht_manth_archive > ul > .list-year > ul.article-list{display:inline-block;box-sizing:border-box;width:70%;list-style:none;padding:.75em 2em;}
