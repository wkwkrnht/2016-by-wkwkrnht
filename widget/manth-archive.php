<style>
    ...
    .widget_wkwkrnht_manth_archive .list-year{margin:1em 0;background-color:#03a9f4;border:1px solid #03a9f4;}
    ...
    .widget_wkwkrnht_manth_archive .article-list{list-style:none;padding:.75em 2em;margin-top:1em;background-color:#fff;display:flex;flex-wrap:wrap;justify-content:flex-start;align-items:center;}
