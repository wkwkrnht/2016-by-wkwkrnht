<style>
	...
	.widget_related_posts .related-wrapper{display:block;height:15vw;width:33vmax;border-radius:3vmin;padding:.5em 1em;margin:2vw 3vw;box-shadow:0 0 2vmin rgba(0,0,0,.3);background-color:#fff;color:#333;text-decoration:none;}
