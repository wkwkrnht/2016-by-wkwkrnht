<style>
	.widget_related_posts{display:flex;flex-wrap:nowrap;justify-content:space-between;align-items:center;height:50vw;width:100%;margin:5vh 0;overflow-x:auto;overflow-y:hidden;-webkit-overflow-scrolling:touch;}
	.widget_related_posts > *{-webkit-transform:translateZ(0px);}
	.widget_related_posts .related-wrapper{display:block;height:18vw;min-width:28vw;border-radius:3vmin;padding:.5em 1em;margin:2vw;box-shadow:0 0 2vmin rgba(0,0,0,.3);background-color:<?php echo get_option('related_background','#fff');?>;color:<?php echo get_option('related_color','#333');?>;text-decoration:none;}
