<style>
	...
	.widget_related_posts .related-wrapper{display:block;height:20vw;min-width:28vw;border-radius:3vmin;padding:.5em 1em;margin:2vw;box-shadow:0 0 2vmin rgba(0,0,0,.3);background-color:<?php echo get_option('related_background_color','#fff');?>;color:<?php echo get_option('related_color','#333');?>;text-decoration:none;}
	.widget_related_posts .related-wrapper:visited{color:<?php echo get_option('related_color','#333');?>;}
	.widget_related_posts .related-title{box-shadow:0 3px 6px rgba(0,0,0,.1);background-color:<?php echo get_option('related_title_background_color','#03a9f4');?>;font-size:2rem;color:<?php echo get_option('related_title_color','#fff');?>;text-align:center;vertical-align:middle;}
