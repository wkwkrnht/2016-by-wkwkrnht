<style>
    ...
    .post-nav a::before{display:block;content:'';height:10vh;width:80vw;position:absolute;top:0;left:0;background-color:rgba(0,0,0,.3);box-shadow:inset 0 0 50px rgba(0,0,0,.4);}
